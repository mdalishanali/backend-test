...
var ProductsHelpers = /** @class */ (function () {
    ...
    ProductsHelpers.findAll = function (query, user) { return __awaiter(void 0, void 0, void 0, function () {
        var page, limit, skips, searchValue, allFilter, filter, applyFilter, query_1, dateQuery, sellerLookupQuery, ordersCountQuery, calculateOrdersCount, unwindQuery, matchQuery, paginationQuery, aggregatePipeline, searchQuery, data;
        var _a;
