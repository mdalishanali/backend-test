...
var SubscriptionRoutes = /** @class */ (function () {
    ...
    SubscriptionRoutes.deleteSubscription = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var planId, data, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    planId = req.params.planId;
                    return [4 /*yield*/, helpers_1.SubscriptionHelpers.deletePlan(planId)];
                case 1:
                    data = _a.sent();
                    res.locals.code = status.OK;
                    res.locals.res_obj = { data: data };
    ...
    SubscriptionRoutes.updateSubscription = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var planId, update, data, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    return [4 /*yield*/, helpers_1.SubscriptionHelpers.updatePlan(planId, update)];
                case 1:
                    data = _a.sent();
                    res.locals.code = status.OK;
                    res.locals.res_obj = { data: data };
