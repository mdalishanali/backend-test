...
var TodoHelpers = /** @class */ (function () {
    ...
    TodoHelpers.findOne = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    TodoHelpers.findAll = function (query) { return __awaiter(void 0, void 0, void 0, function () {
        var page, limit, skips, searchValue, allFilter, matchQuery, paginationQuery, aggregatePipeline, searchQuery, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    TodoHelpers.softDelete = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.Todo
