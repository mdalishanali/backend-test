...
var EmailRoutes = /** @class */ (function () {
    ...
    EmailRoutes.contactForm = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, name_1, email, message, emailService, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, emailService.contactFormSubmission({ name: name_1, email: email, message: message })];
                case 1:
                    _b.sent();
