...
exports.OrdersHelpers = void 0;
// NPM Dependencies
var status = require("http-status");
var StandardError = require("standard-error");
// Internal Dependencies
var db_1 = require("../../db");
var OrdersHelpers = /** @class */ (function () {
    function OrdersHelpers() {
    }
    OrdersHelpers.findOne = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.Orders
                        .findOne({ _id: id, })
    ...
    OrdersHelpers.findAll = function (query, user) { return __awaiter(void 0, void 0, void 0, function () {
        var page, limit, skips, searchValue, allFilter, filter, applyFilter, addToAllFilter, searchFilter, query_1, dateQuery, matchQuery, productLookupQuery, sellerLookupQuery, addSellerFullName, unwindQuery, paginationQuery, sortingQuery, aggregatePipeline, data;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    filter = query.filter;
                    applyFilter = [];
                    addToAllFilter = function (query) {
                        if (allFilter['$and'] && allFilter['$and'].length) {
                            allFilter['$and'] = __spreadArray(__spreadArray([], allFilter['$and']), [query]);
                        }
                        else {
                            allFilter['$and'] = [query];
                        }
                    ...
                    if (filter && Object.keys(filter).length) {
                        searchFilter = ["name"];
                        searchFilter.forEach(function (key) {
                            var _a;
                            if (filter[key]) {
                                var data_1 = (_a = {},
                                    _a[key] = filter[key],
                                    _a);
                                applyFilter.push(data_1);
                            }
                        });
                    }
                    ...
                    if ((_b = filter === null || filter === void 0 ? void 0 : filter.ByStatus) === null || _b === void 0 ? void 0 : _b.length) {
                        allFilter['paymentStatus'] = filter === null || filter === void 0 ? void 0 : filter.ByStatus;
                    }
                    ...
                    if ((_c = filter === null || filter === void 0 ? void 0 : filter.category) === null || _c === void 0 ? void 0 : _c.length) {
                        allFilter.category = {
                            '$in': filter.category
                        };
                    }
                    ...
                    unwindQuery = [{ "$unwind": { path: "$seller" } }, { "$unwind": { path: "$product" } }];
                    paginationQuery = {
                        $facet: {
                            data: [
                                {
                    ...
                    aggregatePipeline = __spreadArray(__spreadArray([
                        sortingQuery,
                        productLookupQuery,
                        sellerLookupQuery
                    ], unwindQuery), [
                    ...
                    return [4 /*yield*/, db_1.Orders.aggregate(aggregatePipeline)];
                case 1:
                    data = _d.sent();
    ...
    OrdersHelpers.findAndUpdate = function (_a) {
    ...
    OrdersHelpers.create = function (document) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.Orders
                        .create(document)];
    ...
    OrdersHelpers.softDelete = function (id, user) { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.Orders
    ...
    OrdersHelpers.authenticate = function (doc, user) {
    ...
    return OrdersHelpers;
}());
exports.OrdersHelpers = OrdersHelpers;
