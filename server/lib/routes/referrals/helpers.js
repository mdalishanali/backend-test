...
var ReferralHelpers = /** @class */ (function () {
    ...
    ReferralHelpers.findAll = function (query) { return __awaiter(void 0, void 0, void 0, function () {
        var referredBy, page, limit, skips, allFilter, filter, applyFilter, dateQuery, matchQuery, referredToLookup, unwindQuery, referredTo, sortingQuery, paginationQuery, aggregatePipeline, data;
