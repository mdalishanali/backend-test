...
var RefundHelpers = /** @class */ (function () {
    ...
    RefundHelpers.findOne = function (id, companyId) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, db_1.Refund
                    .findOne({ _id: id, })
                    .populate('')];
        });
    }); };
    RefundHelpers.getAllRefunds = function (query, userId) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    matchObj = { user: ObjectId(userId) };
                    if (Boolean(searchValue)) {
                        matchObj.$text = { $search: searchValue };
                    }
                    return [4 /*yield*/, db_1.Refund.aggregate([
                            {
                                $match: matchObj
                            },
                            {
                ...
                case 1:
                    ...
                    processedData = data[0].data.map(function (item) {
                        ...
                        item.formattedTime = moment(item.createdAt).format('MMMM Do YYYY, h:mm:ss a');
                        return item;
                    });
