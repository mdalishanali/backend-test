...
var ProductsHelpers = /** @class */ (function () {
    ...
    ProductsHelpers.findOne = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    ProductsHelpers.findAll = function (query) { return __awaiter(void 0, void 0, void 0, function () {
        var page, limit, skips, searchValue, allFilter, filter, applyFilter, searchFilter, query_1, sellerLookupQuery, ordersCountQuery, calculateOrdersCount, unwindQuery, matchQuery, paginationQuery, aggregatePipeline, searchQuery, data;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if ((_a = filter === null || filter === void 0 ? void 0 : filter.category) === null || _a === void 0 ? void 0 : _a.length) {
                        allFilter.category = {
                            '$in': filter.category
                        };
                    }
    ...
    ProductsHelpers.softDelete = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.Products
