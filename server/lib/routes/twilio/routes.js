...
var TwilioRoutes = /** @class */ (function () {
    function TwilioRoutes() {
    }
    TwilioRoutes.send = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, num, message, messageservice;
        return __generator(this, function (_b) {
            try {
                _a = req.body, num = _a.number, message = _a.message;
                messageservice = new message_1.MessageService();
